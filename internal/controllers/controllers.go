...
func UpdateSetting(c *gin.Context) {
    ...
    settingMap := map[string]interface{}{
        ...
        "frontend_settings": map[string]interface{}{
            ...
            "card_footer_title":    setting.FrontendSettings.CardFooterTitle,
            "card_footer_subtitle": setting.FrontendSettings.CardFooterSubtitle,
            "card_footer_link":     setting.FrontendSettings.CardFooterLink,
            "page_footer_html":     setting.FrontendSettings.PageFooterHTML,
            "rss_title":           setting.FrontendSettings.RSSTitle,
            "rss_description":      setting.FrontendSettings.RSSDescription,
            "rss_author_name":      setting.FrontendSettings.RSSAuthorName,
            "rss_favicon_url":      setting.FrontendSettings.RSSFaviconURL,
			"waline_server_url":    setting.FrontendSettings.WalineServerURL,
        },
    }

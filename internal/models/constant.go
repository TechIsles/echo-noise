...
const (
	SuccessMessage               = "请求成功"
	GetAllMessagesSuccess        = "获取笔记成功"
	GetMessageByIDSuccess        = "获取笔记成功"
	PostMessageSuccess           = "发布笔记成功"
	CreateSuccessMessage         = "创建成功"
	QuerySuccessMessage          = "查询成功"
	DeleteSuccessMessage         = "删除成功"
	ServerLaunchSuccessMessage   = "服务器启动成功"
	GetMessagesByPageSuccess     = "分页获取笔记成功"
...
const (
	...
	GetAllMessagesFailMessage              = "获取笔记失败"
	GetMessageByIDFailMessage              = "获取笔记失败"
	MessageNotFoundMessage                 = "笔记未找到"
	PostMessageFailMessage                 = "发布笔记失败"
	...
	GetMessagesByPageFailMessage           = "分页获取笔记失败"
